// =============================================================================
// <copyright file="PARequestLifecycleAlbaBootstrap.cs" company="Levelup Software">
...
/// <summary>
/// Alba bootstrap for PA request lifecycle integration tests.
/// Uses EF Core in-memory database and mocked external services.
/// </summary>
public sealed class PARequestLifecycleAlbaBootstrap : IAsyncInitializer, IAsyncDisposable
{
    /// <summary>
    ...
    public async Task InitializeAsync()
    {
        Host = await AlbaHost.For<Program>(config =>
        {
            ...
            config.ConfigureServices(services =>
            {
                ...
                var databaseName = $"PALifecycleTest_{Guid.NewGuid()}";
                ...
                // Replace IFhirTokenProvider with mock
