...
PATIENT_DATA = {
    ...
    # Diagnosis
    "diagnosis": "Chronic migraine without aura, intractable, with status migrainosus",
    "icd_code": "G43.709",
...
def main():
    ...
    input_pdf = project_root / "assets" / "pdf-templates" / "co-prescription-drug-prior-authorizathion-request-form.pdf"
    output_pdf = project_root / "assets" / "pdf-templates" / "co-prescription-drug-prior-authorizathion-request-form-filled-jane-doe.pdf"
